...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/tinyverse-web3/btcd/peer)
...
```bash
$ go get -u github.com/tinyverse-web3/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/tinyverse-web3/btcd/peer#example-package--NewOutboundPeer)  
