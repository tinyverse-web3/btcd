...
* Install the MSI available at: [btcd windows installer](https://github.com/tinyverse-web3/btcd/releases)
...
```bash
git clone https://github.com/tinyverse-web3/btcd $GOPATH/src/github.com/tinyverse-web3/btcd
...
* [Using bootstrap.dat](https://github.com/tinyverse-web3/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
