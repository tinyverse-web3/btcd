...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/tinyverse-web3/btcd/netsync)
...
```bash
$ go get -u github.com/tinyverse-web3/btcd/netsync
```
